...
class EmailTempConPageAfterSearch extends StatefulWidget {
  @override
  _EmailTempConPageAfterSearchState createState() =>
      _EmailTempConPageAfterSearchState();

  static const routeName = '/email-temp-con-page-after-search';
}

class _EmailTempConPageAfterSearchState
    extends State<EmailTempConPageAfterSearch> {
