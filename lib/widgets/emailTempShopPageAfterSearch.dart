...
class EmailTempShopPageAfterSearch extends StatefulWidget {
  @override
  _EmailTempShopPageAfterSearchState createState() =>
      _EmailTempShopPageAfterSearchState();

  static const routeName = '/email-temp-shop-page-after-search';
}

class _EmailTempShopPageAfterSearchState
    extends State<EmailTempShopPageAfterSearch> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Send System Email'),
        centerTitle: true,
        actions: <Widget>[
          IconButton(
            onPressed: send,
