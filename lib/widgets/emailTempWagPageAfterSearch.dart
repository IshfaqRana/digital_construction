...
class EmailTempWagPageAfterSearch extends StatefulWidget {
  @override
  _EmailTempWagPageAfterSearchState createState() =>
      _EmailTempWagPageAfterSearchState();

  static const routeName = '/email-temp-wag-page-after-search';
}

class _EmailTempWagPageAfterSearchState
    extends State<EmailTempWagPageAfterSearch> {
