...
class Con_View_On_ID_Click extends StatefulWidget {
  const Con_View_On_ID_Click({
    Key? key,
  }) : super(key: key);

  static const routeName = '/Con_View_On_ID_Click';

  @override
  State<Con_View_On_ID_Click> createState() => _Con_View_On_ID_ClickState();
}

class _Con_View_On_ID_ClickState extends State<Con_View_On_ID_Click> {
  ...
  void didChangeDependencies() {
    ...
    final constructorIDArg =
        ModalRoute.of(context)!.settings.arguments as Map<String, dynamic>;

    searchText = constructorIDArg['constructorID'] as String;
    super.didChangeDependencies();
  }
