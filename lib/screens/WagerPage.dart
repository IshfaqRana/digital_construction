...
class WagerPage extends StatefulWidget {
  ...
  static const routeName = '/wager-page';

  @override
  State<WagerPage> createState() => _WagerPageState();
}
...
class _WagerPageState extends State<WagerPage> {
  ...
  Widget build(BuildContext context) {
    ...
    // final wagerProviderData = Provider.of<WagerProvider>(context).wagers;
    ...
    return Scaffold(
      ...
      body: StreamBuilder(
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          ...
          if (wagerDataNotApproved.isEmpty) {
            return Center(
                child: Text(
              'No Pending Data',
              style: TextStyle(
                        ...
                        children: [
                          ...
                          RichText(
                            ...
                            children: [
                              ...
                              TextSpan(
                                text: wagerDataNotApproved[index]['experience'],
                                style: TextStyle(color: Colors.black),
                              ),
                            ],
                          )),
                          RichText(
                            ...
                            children: [
                              ...
                              TextSpan(
                                text: wagerDataNotApproved[index]['expertise'],
                                style: TextStyle(color: Colors.black),
                              ),
                            ],
                          )),
                          RichText(
                            ...
                            children: [
                              ...
                              TextSpan(
                                text: wagerDataNotApproved[index]['myRating']
                                    .toString(),
                                style: TextStyle(color: Colors.black),
                              ),
                            ],
                          ...
                          Row(
                            ...
                            children: [
                              FlatButton(
                                  ...
                                  onPressed: () {
                                    print(
                                        'ID=' + wagerDataNotApproved[index].id);
                                          ...
                                          actions: [
                                            FlatButton(
                                              ...
                                              onPressed: () {
                                                ...
                                                print('ID=' +
                                                    wagerDataNotApproved[index]
                                                        .id);
                                                FirebaseFirestore.instance
                                                    .collection('Wagers')
                                                    .doc(wagerDataNotApproved[
                                                            index]
                                                        .id)
                                                    .delete();
