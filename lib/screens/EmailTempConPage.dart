...
class EmailTempConPage extends StatefulWidget {
  @override
  _EmailTempConPageState createState() => _EmailTempConPageState();

  static const routeName = '/email-temp-con-page';
}

class _EmailTempConPageState extends State<EmailTempConPage> {
  ...
  final _subjectController = TextEditingController(
    text: 'Rejection of your constructor account\ncreation request.',
  );
