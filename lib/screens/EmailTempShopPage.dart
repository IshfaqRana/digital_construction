...
class EmailTempShopPage extends StatefulWidget {
  @override
  _EmailTempShopPageState createState() => _EmailTempShopPageState();

  static const routeName = '/email-temp-shop-page';
}

class _EmailTempShopPageState extends State<EmailTempShopPage> {
  ...
  final _subjectController = TextEditingController(
    text: 'Rejection of your Shop account\ncreation request.',
  );
